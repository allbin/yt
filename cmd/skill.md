---
name: yt
description: "Interact with YouTrack: fetch issue details by ID, list and filter issues. Use when referencing issue keys (e.g. PROJ-123) or searching issues."
...
For a list: compact table with ID, state, priority, assignee, summary.
